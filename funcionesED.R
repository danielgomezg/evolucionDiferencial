...
setup <- function(datos, p, numCluster, features , tamaño, cantDatos){
...
bestIndividuo <- function(datos, poblacion, features, numCluster, tamaño){
...
individuosRend <- function(datos, poblacion, numCluster, tamaño){
